...
public class ItemConta {
    ...
    public MenuItem getItemCardapio() {
        return itemCardapio;
    }

    public void setItemCardapio(MenuItem itemCardapio) {
    ...
    public User getQuemLancou() {
        return quemLancou;
    }

    public void setQuemLancou(User quemLancou) {
        this.quemLancou = quemLancou;
    }

    public User getQuemRemoveu() {
        return quemRemoveu;
    }

    public void setQuemRemoveu(User quemRemoveu) {
